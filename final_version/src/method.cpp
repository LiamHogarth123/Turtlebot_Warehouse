...
void Method::Generate_Turtlebots(int x){
  //Create turtlebot section
  /////////////////////////////////////////////////////////
  ros::NodeHandle nh_1;
  DefaultTurtleBot* tb1 =  new DefaultTurtleBot("tb3_0", nh_1);
  ros::NodeHandle nh_2;
  DefaultTurtleBot* tb2 =  new DefaultTurtleBot("tb3_1", nh_2);
  ros::NodeHandle nh_3;
  DefaultTurtleBot* tb3 =  new DefaultTurtleBot("tb3_2", nh_3);
  ...
  trajectory.resize(turtlebots.size());
}
...
void Method::Task_Alloction_Completion(){
...
void Method::path_checker_function(){
...
void Method::separateThread() {
  ...
  //Create turtlebot section
  /////////////////////////////////////////////////////////
  int user_specificed_turtlebots;
  std::cout << "Generating Turtlebots-----------------------------------";
  std::cout << "How many turtlebots would you like?";
  std::cin >> user_specificed_turtlebots;
  if (user_specificed_turtlebots > 3){
    user_specificed_turtlebots = 3;
  }
  

  std::cout << "Turtlebot Created-----------------" << std::endl;
  Generate_Turtlebots(user_specificed_turtlebots);
  

  Task_Alloction_Completion();
  std::cout << "Task allocation completed------------------------------" << std::endl;

  generate_Prm();
  std::cout << "PRM Generation Completed------------------------------" << std::endl;
  ...
  if (Synchronous){
    for (int i = 0; i < largestSize; i++){
      ...
      std::cout << "Combined points size: " << combinedPoints.size() << std::endl;
      ...
      for (size_t j = 0; j < turtlebots.size(); j++) {
        ...
        // std::cout << "Trajectory for TurtleBot " << j << ":" << std::endl;
        // for (const auto& point : trajectory.at(j)) {
        //     std::cout << "  (" << point.x << ", " << point.y << ", " << point.z << ")" << std::endl;
        // }

        // Print TurtleBot information
    
        std::cout << "TurtleBot " << j << " info:" << std::endl;
        std::cout << "TurtleBot " << turtlebots.size()  << std::endl;


        // Print TurtleController information
        std::cout << "TurtleController " << j << " info:" << std::endl;
        std::cout << Turtle_Controllers.size()  << std::endl;
...
visualization_msgs::MarkerArray Method::publishMarkers(const std::vector<geometry_msgs::Point>& nodes, ros::Publisher& marker_pub) {
  ...
  for (const auto& node : nodes) {
      ...
      std::cout << "goals working" << std::endl;
