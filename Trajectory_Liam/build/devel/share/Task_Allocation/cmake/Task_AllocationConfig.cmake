...
if("TRUE" STREQUAL "TRUE")
  set(Task_Allocation_SOURCE_PREFIX /home/liam/git/Turtlebot_Warehouse/Task_Allocation_Brendan)
  set(Task_Allocation_DEVEL_PREFIX /home/liam/git/Turtlebot_Warehouse/Task_Allocation_Brendan/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Task_Allocation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liam/git/Turtlebot_Warehouse/Task_Allocation_Brendan/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT Task_Allocation_NUM_DUMMY_TARGETS)
      set(Task_Allocation_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::Task_Allocation::wrapped-linker-option${Task_Allocation_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR Task_Allocation_NUM_DUMMY_TARGETS "${Task_Allocation_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::Task_Allocation::wrapped-linker-option${Task_Allocation_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND Task_Allocation_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/liam/git/Turtlebot_Warehouse/Task_Allocation_Brendan/build/devel/lib;/home/liam/catkin_ws/devel/lib;/opt/ros/melodic/lib)
...
set(Task_Allocation_EXPORTED_TARGETS "")
