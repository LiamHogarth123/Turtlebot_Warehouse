...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/liam/git/Turtlebot_Warehouse/map_server)
  set(map_server_DEVEL_PREFIX /home/liam/git/Turtlebot_Warehouse/map_server/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Liam <liam@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/liam/git/Turtlebot_Warehouse/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/liam/git/Turtlebot_Warehouse/map_server/build/devel/lib;/home/liam/catkin_ws/devel/lib;/opt/ros/melodic/lib)
